...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dhanuka Navodya — Software Engineer" },
      { name: "description", content: "Portfolio of Dhanuka Navodya, a full-stack software engineer crafting elegant, performant products." },
      { property: "og:title", content: "Dhanuka Navodya — Software Engineer" },
      { name: "twitter:title", content: "Dhanuka Navodya — Software Engineer" },
      { property: "og:description", content: "Portfolio of Dhanuka Navodya, a full-stack software engineer crafting elegant, performant products." },
      { name: "twitter:description", content: "Portfolio of Dhanuka Navodya, a full-stack software engineer crafting elegant, performant products." },
